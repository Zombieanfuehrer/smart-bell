...
void run_tcp_server(Ethernet::EmbeddedSocketW5500* socket_manager) {
...
serial::SPI_parameters spi_params = {serial::SPI_mode::kMaster, serial::SPI_data_order::kMsb_first,
                                     serial::SPI_clock_polarity::kIdle_low,
                                     serial::SPI_clock_phase::kLeading,
                                     serial::SPI_clock_rate::k4mHz};

serial::Serial_parameters uart_parms = {serial::Communication_mode::kAsynchronous,
